...
app_ui = ui.page_fluid(
    ...
    ui.row(
        ui.column(6, ui.row(
            ...
            ui.column(10, ui.p("Georgios Fotakis", style=font_style)),
        ),
                  ui.row(
                ui.column(2, ui.img(src="address2.png", width="32px"), style="text-align: center;"),
                ui.column(10, ui.p('OmicaNexus.ai', style = font_style))
                ),ui.row(
                ui.column(2, ),
                ui.column(10, ui.p('11474 Athens', style = font_style))
                ),
                ui.row(
                ui.column(2, ),
                ui.column(10, ui.p('Greece', style = font_style))
                ),
                      ui.row(
                ui.column(2, ui.img(src="mail2.png", width="32px"), style="text-align: center;"),
                ui.column(10, ui.a(ui.p('fotakisg@gmail.com'), href="mailto:fotakisg@gmail.com", style = font_style))
                ),
